...
def setup_scene(scene_idx):
    ...
    # ---------------------------
    # Make the floor passive
    plane.enable_rigidbody(active=False)

    # Make each object an active rigid body
    for obj in objects:
        obj.enable_rigidbody(active=True)

    # Drop them and fix their final resting poses
    # Runs at least 4s, at most 20s, checking every 1s until all motion ceases
